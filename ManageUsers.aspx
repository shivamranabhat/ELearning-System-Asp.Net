<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="ELearning.WebForm7" %>
              ...
              <asp:GridView ID="gridview1" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="First Name">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtFNameFtr" runat="server" />
                    ...
                    <asp:TemplateField HeaderText="Last Name">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtLNameFtr" runat="server" />
                    ...
                    <asp:TemplateField HeaderText="Address">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtAddressFtr" runat="server" />
                     ...
                     <asp:TemplateField HeaderText="Phone">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtPhoneFtr" runat="server" />
                    ...
                    <asp:TemplateField HeaderText="Email">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtEmailFtr" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Password">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtPasswordFtr" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="UserType">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtUserTypeFtr" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
